...
COPY /Y /V "bin_icl12\%1\%~2\peerblock.exe" "temp_zip\"
COPY /Y /V "bin_icl12\%1\%~2\pbfilter.sys"  "temp_zip\"
...
MOVE /Y "PeerBlock_r%buildnum%__%1_%~2_icl12.zip" "..\..\..\distribution" >NUL
ECHO.
POPD
