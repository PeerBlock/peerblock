...
#define BUILDDATE 1010100
	...
	#define PB_BLDSTR "PeerBlock " STRINGIFY(PB_VER_MAJOR) "." STRINGIFY(PB_VER_MINOR) "+" " (r" STRINGIFY(PB_VER_BUILDNUM) ") - INTERNAL TEST RELEASE"
#endif
#ifdef PB_RELTYPE_DEV
	#define PB_BLDSTR "PeerBlock " STRINGIFY(PB_VER_MAJOR) "." STRINGIFY(PB_VER_MINOR) "+" " (r" STRINGIFY(PB_VER_BUILDNUM) ") - DEV BUILD"
#endif
