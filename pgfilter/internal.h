...
#define HTONLL(ll) _byteswap_uint64(ll)
...
typedef struct __pg_internal {
	...
	PGIP6RANGE *blocked6ranges;
	ULONG blocked6count, blocked6labelsid;

	PGIP6RANGE *allowed6ranges;
	ULONG allowed6count, allowed6labelsid;
