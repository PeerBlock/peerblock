...
//void BlockWithoutUpdate(HWND hwnd)
//{
	//UpdateThread ut(NULL, NULL, NULL, false);
	//ut._ProcessWithoutUpdate();
	...
	//UpdateThread ut(NULL, NULL, NULL, false);
	//boost::shared_ptr<thread> put=boost::shared_ptr<thread>(new thread(boost::ref(ut)));
	//delete ut;
//}
