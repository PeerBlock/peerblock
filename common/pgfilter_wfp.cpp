...
void pgfilter::install_callout() {
	FWPM_SESSION0 ses = {0};
	ses.displayData.name = L"PeerGuardian 3 Dynamic Session";
	ses.displayData.description = L"PeerGuardian 3 firewall callout.";
	...
	ocallout4.displayData.name = L"PeerGuardian 3 IPv4 Flow Outbound Callout";
	...
	icallout4.displayData.name = L"PeerGuardian 3 IPv4 Flow Inbound Callout";
	...
	ocallout6.displayData.name = L"PeerGuardian 3 IPv6 Flow Outbound Callout";
	...
	icallout6.displayData.name = L"PeerGuardian 3 IPv6 Flow Inbound Callout";
	...
	monitor.displayData.name = L"PeerGuardian 3 Sub layer";
	...
	ofilter4.displayData.name = L"PearGuardian 3 Flow Outbound Filter for IPv4.";
	...
	ifilter4.displayData.name = L"PearGuardian 3 Flow Inbound Filter for IPv4.";
	...
	ofilter6.displayData.name = L"PearGuardian 3 Flow Outbound Filter for IPv6.";
	...
	ifilter6.displayData.name = L"PearGuardian 3 Flow Inbound Filter for IPv6.";
...
void pgfilter::remove_callout() {
	/*FWPM_SESSION0 ses = {0};
	ses.displayData.name = L"PeerGuardian 3 Non-Dynamic Session";
	ses.displayData.description = L"PeerGuardian 3 is removing the firewall callout.";
